    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Schamas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Schamas_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SharedSchemas_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SharedSchemas_AspNetUsers_SharedWithUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SchemaId = table.Column<int>(type: "int", nullable: false),
                    LineCategoryId = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LongestLineName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LongestLineStationCount = table.Column<int>(type: "int", nullable: false),
                    MostConnectedStationName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MostConnectedStationConnectionCount = table.Column<int>(type: "int", nullable: false),
                    TotalNetworkLength = table.Column<double>(type: "float", nullable: false),
                    CalculatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SchemaStatistics", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SchemaStatistics_Schamas_SchemaId",
                        column: x => x.SchemaId,
                        principalTable: "Schamas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Schamas_OwnerId",
                table: "Schamas",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_SchemaStatistics_SchemaId",
                table: "SchemaStatistics",
                column: "SchemaId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SharedSchemas_OwnerId",
                table: "SharedSchemas",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_SharedSchemas_SharedWithUserId",
                table: "SharedSchemas",
